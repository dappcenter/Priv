...
MAINNET_PORT="57889"
TESTNET_PORT="57888"
PHRASE="Some nescafe in the morning"
...
GENESIS_REWARD_PUBKEY=04968a6aeb6b4e705bceb2a94e9d0c04ec68cd95ea5e279b9621aa3829b5a402483fe510845807ef7842ecb332aaddc132cdaff24d2afeed1237e340180a7f6e26
...
newcoin_replace_vars()
{
    ...
    if [ -n "$PREMINED_AMOUNT" ]; then
        $SED -i "s/CAmount nSubsidy = 25 \* COIN;/if \(nHeight == 1\) return COIN \* $PREMINED_AMOUNT;\n    CAmount nSubsidy = 25 \* COIN;/" src/validation.cpp
    fi
